...
X_test<-read.table("./c3proj/X_test.txt")
X_train<-read.table("./c3proj/X_train.txt")
y_test<-read.table("./c3proj/y_test.txt")
y_train<-read.table("./c3proj/y_train.txt")
subject_train<-read.table("./c3proj/subject_train.txt")
subject_test<-read.table("./c3proj/subject_test.txt")
features<-read.table("./c3proj/features.txt")
activity_labels<-read.table("./c3proj/activity_labels.txt")

#assign Activity labels to x/y_test files
...
#output files
write.csv(final,file = "./c3proj/FinalOutput.csv")
write.csv(finaltidy, file ="./c3proj/FinalTidyOutput.csv")
